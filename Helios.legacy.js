(() => {
	...
	window.addEventListener("load", () => {
		...
		var scripts = ["Core.util.Helios.js", "Core.Math.Helios.js", "Core.Worker.js", "Core.Render.Interface.Helios.js", "Core.Surface.Helios.js", "Core.ThreadAgent.Helios.js", "Core.game.Object.Helios.js", "Core.game.Helios.js", "Core.game.UI.Helios.js", "Core.game.Color.Helios.js"];
		var a = 0;
		scripts.forEach((_, b) => {
			a++;
			this.setTimeout(j => {
